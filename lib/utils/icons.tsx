/**
 * Centralized icon library for consistent icon usage across the application
 * All icons are SVG-based for scalability and theme compatibility
 */
...
// Base icon wrapper for consistent sizing and accessibility
function Icon({ 
  children, 
  className = 'w-5 h-5', 
...
export const Icons = {
  ...
  // Info Icons
  InformationCircle: (props: IconProps) => (
    <Icon {...props}>
  ...
  Spinner: (props: IconProps) => (
    <svg
      className={props.className || 'w-5 h-5 animate-spin'}
